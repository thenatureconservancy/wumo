...
* The Colorado Plateau Pinyon-Juniper Woodland is the most prevalent ecosystem mapped on the landscape today at ~15%.
* No converted land uses (e.g., agriculture or developed) are represented in the top 10 EVTs.  
* Most shrubs and tree vegetation has relativity low canopy cover (i.e., 10 - 50%).  
* Most trees are less than 20M; most shrubs are in the tallest category, 1 - 5M.
...
From this information, we can see that the majority of this subregion is classified as “tree” comprising approximately 60% of the vegetation cover.
...
From these results, most trees are between 1 - 20M tall and most shrubs are between 1 - 5M tall.
