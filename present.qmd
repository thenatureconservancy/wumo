...
* No converted land uses (i.e., agriculture or developed) are represented in the top 10 EVTs.  
* Most shrubs and tree vegetation have relativity low canopy cover (i.e., 10 - 50%).  
